    ...
    return (
        <div className='grid lg:grid-cols-9 my-10 mx-3 '>
            ...
            <div className='lg:col-start-4 lg:col-span-3 bg-slate-300 p-10 rounded-lg '>
                ...
                <hr className=" mx-auto w-48 h-1 bg-gray-100 rounded border-0 md:my-10 dark:bg-gray-700" />
                ...
                <div >
                    ...
                    <button onClick={handleGitHubLogIn} className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
