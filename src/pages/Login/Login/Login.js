            ...
            <div className='lg:col-start-4 lg:col-span-3 bg-slate-300 p-10 rounded-lg '>
                ...
                <form>
                    ...
                    <div className="flex items-start mb-6">
                        ...
                        <label for="remember" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Don't have an account <Link className='text-blue-600' to="/register">Register</Link></label>
                    </div>
