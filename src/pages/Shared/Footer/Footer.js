        ...
        <div>
            ...
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link className="flex items-center">
                            <img src={sf} className="mr-3 h-8" alt="FlowBite Logo" />
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <Link to="/" className="hover:underline ">Surface Coding</Link>
                                </li>
                                <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <Link to="/" className="hover:underline">Surface Coding</Link>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        ...
                        <Link href="#" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <span className="sr-only">Dribbel account</span>
                        </Link>
                    </div>
                </div>
            </footer>
